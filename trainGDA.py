        ...
        for epoch in train_iterator:
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                if (step + 1) == len(train_dataloader) - 1 or (args.evaluation_steps > 0 and num_steps % args.evaluation_steps == 0 and step % args.gradient_accumulation_steps == 0):
                   ...
                   print(dev_output)
                   print(test_output)
                   with open('./saved_model/gdalogcopys.txt', 'a') as f:
...
def main():
    ...
    parser.add_argument("--model_name_or_path", default="./sci_bert", type=str)
    ...
    parser.add_argument("--save_path", default="./saved_model/GDABEST.model", type=str)
    ...
    parser.add_argument("--gat_layers", type=int, default=5,
                        help="Number of relation types in dataset.")
    parser.add_argument("--gat_headnum", type=int, default=5,
                        help="Number of relation types in dataset.")
    parser.add_argument("--gat_drop", type=float, default=0.2,
                        help="Number of relation types in dataset.")
